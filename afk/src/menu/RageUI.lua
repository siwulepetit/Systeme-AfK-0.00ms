...
TextureMenu = CreateDui("https://cdn.discordapp.com/attachments/990251474749640854/990267013777719386/Holaaaaaaa.gif",500, 500)
local tx = CreateRuntimeTextureFromDuiHandle(CreateRuntimeTxd("harley"), "Quinn", GetDuiHandle(TextureMenu))
AddReplaceTexture("commonmenu", "interaction_bgd", "harley", "Quinn")
end)
